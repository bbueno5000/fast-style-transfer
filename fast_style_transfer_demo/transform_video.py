...
def build_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        dest='checkpoint',
        help='checkpoint directory or .ckpt file',
        metavar='CHECKPOINT',
        required=True)
    parser.add_argument(
        '--in-path',
    ...
    parser.add_argument(
        ...
        type=str,
        dest='out',
        help='path to save processed video to',
        metavar='OUT',
        required=True)
    parser.add_argument(
        '--tmp-dir',
...
def check_opts(opts):
    utils.exists(opts.checkpoint)
    utils.exists(opts.out)
